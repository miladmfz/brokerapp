...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<Good> getAllGood(String search, Integer aGroupCode, Boolean aOnlyActive, Boolean aOnlyAvailable, Integer itemamount) {
        ...
        if (c != null) {
            while (c.moveToNext()) {
                ...
                gooddetail.setShortage(c.getString(c.getColumnIndex("Shortage")));
                gooddetail.setRowCode(c.getString(c.getColumnIndex("RowCode")));
                gooddetail.setGoodCode(c.getString(c.getColumnIndex("GoodCode")));
                ...
                gooddetail.setMaxSellPrice(c.getString(c.getColumnIndex("MaxSellPrice")));
                gooddetail.setSellPrice1(c.getString(c.getColumnIndex("SellPrice1")));
                gooddetail.setPrice(c.getString(c.getColumnIndex("Price")));
                gooddetail.setImageName(c.getString(c.getColumnIndex("GoodExplain6")));
                gooddetail.setAmount(c.getString(c.getColumnIndex("StackAmount")));
                gooddetail.setGoodType(c.getString(c.getColumnIndex("GoodType")));
                gooddetail.setUnitName(c.getString(c.getColumnIndex("UnitName")));
                gooddetail.setDefaultUnitValue(c.getString(c.getColumnIndex("DefaultUnitValue")));
                gooddetail.setReservedAmount(c.getString(c.getColumnIndex("ReservedAmount")));
    ...
    public Good getGoodByCode(Integer code, Integer pfcode) {
        ...
        if (c.getCount() > 0) {
            ...
            gooddetail.setFloat1(c.getString(c.getColumnIndex("Float1")));
            ...
            gooddetail.setFloat5(c.getString(c.getColumnIndex("Float5")));
            gooddetail.setFactorAmount(c.getString(c.getColumnIndex("FactorAmount")));
            gooddetail.setUnitName(c.getString(c.getColumnIndex("UnitName")));
            gooddetail.setReservedAmount(c.getString(c.getColumnIndex("ReservedAmount")));
            try {
            ...
            if (mContext.getString(R.string.app_name).equals("چشمه")) {
                ...
                gooddetail.setAmount1(c.getString(c.getColumnIndex("StackAmount2")));
                gooddetail.setAmount2(c.getString(c.getColumnIndex("StackAmount3")));
            }
    ...
    public ArrayList<Good> getAllGood_pfcode(Integer pfcode) {
        ...
        if (c != null) {
            while (c.moveToNext()) {
                Good gooddetail = new Good();
                gooddetail.setGoodCode(c.getString(c.getColumnIndex("GoodCode")));
                gooddetail.setGoodMainCode(c.getString(c.getColumnIndex("GoodMainCode")));
                gooddetail.setGoodName(c.getString(c.getColumnIndex("GoodName")));
                gooddetail.setMaxSellPrice(c.getString(c.getColumnIndex("MaxSellPrice")));
                gooddetail.setPrice(c.getString(c.getColumnIndex("Price")));
                gooddetail.setFactorAmount(c.getString(c.getColumnIndex("FactorAmount")));
    ...
    public ArrayList<PreFactor> getAllPrefactorHeaderopen() {
        ...
        if (c != null) {
            while (c.moveToNext()) {
                ...
                prefactor.setPreFactorCode(c.getString(c.getColumnIndex("PreFactorCode")));
                ...
                prefactor.setPreFactorKowsarCode(c.getString(c.getColumnIndex("PreFactorKowsarCode")));
                ...
                prefactor.setSumAmount(c.getString(c.getColumnIndex("SumAmount")));
                prefactor.setSumPrice(c.getString(c.getColumnIndex("SumPrice")));
                prefactor.setRowCount(c.getString(c.getColumnIndex("RowCount")));
    ...
    public ArrayList<Good> getAllPreFactorRows(String name, Integer aPreFactorCode) {
        ...
        if (c != null) {
            while (c.moveToNext()) {
                ...
                gooddetail.setUnitName(c.getString(c.getColumnIndex("UnitName")));
                gooddetail.setDefaultUnitValue(c.getString(c.getColumnIndex("DefaultUnitValue")));
                gooddetail.setAmount(c.getString(c.getColumnIndex("FactorAmount")));
                gooddetail.setGoodType(c.getString(c.getColumnIndex("GoodType")));
                goods.add(gooddetail);
            }
        }
    ...
    public String GetLastPreFactorHeader() {
        ...
        if (c.getCount() > 0) {
            c.moveToNext();
            Res = c.getString(c.getColumnIndex("PreFactorCode"));
        }
        c.close();
        return Res;
    }
    ...
    public String getFactorSumAmount(Integer pfcode) {
        SQLiteDatabase db = getReadableDatabase();
    ...
    public String getFactorcode(Integer pfcode) {
        SQLiteDatabase db = getReadableDatabase();
    ...
    public ArrayList<Customer> AllCustomer(String name, boolean aOnlyActive) {
        ...
        if (c != null) {
            while (c.moveToNext()) {
                ...
                customerdetail.setCustomerCode(c.getString(c.getColumnIndex("CustomerCode")));
                customerdetail.setPriceTip(c.getString(c.getColumnIndex("PriceTip")));
                ...
                customerdetail.setBestankar(c.getString(c.getColumnIndex("Bestankar")));
                customerdetail.setActive(c.getString(c.getColumnIndex("Active")));
                customerdetail.setCentralPrivateCode(c.getString(c.getColumnIndex("CentralPrivateCode")));
                customerdetail.setEtebarNaghd(c.getString(c.getColumnIndex("EtebarNaghd")));
                customerdetail.setEtebarCheck(c.getString(c.getColumnIndex("EtebarCheck")));
                customerdetail.setTakhfif(c.getString(c.getColumnIndex("Takhfif")));
    ...
    public String Customer_check(String name) {
        String res="0";
        ...
        if (c != null) {
            while (c.moveToNext()) {
                res = c.getString(c.getColumnIndex("CentralCode"));
            }
        }
        c.close();
        return res;
    ...
    public String getCustomerGoodSellPrice(Integer aPreFactorHeaderCode, Integer aGoodCode) {
        String iResult = "0";
        ...
        if (c.getCount() > 0) {
            c.moveToFirst();
            iResult = c.getString(c.getColumnIndex("Price"));
        }
        c.close();
        return iResult;
    }
    ...
    public ArrayList<GoodGroup> getAllGroups(String GName, Integer GL) {
        ...
        if (c != null) {
            while (c.moveToNext()) {
                ...
                grp.setGoodGroupCode(c.getString(c.getColumnIndex("GroupCode")));
                grp.setName(c.getString(c.getColumnIndex("Name")));
                grp.setL1(c.getString(c.getColumnIndex("L1")));
                grp.setL2(c.getString(c.getColumnIndex("L2")));
                grp.setL3(c.getString(c.getColumnIndex("L3")));
                grp.setL4(c.getString(c.getColumnIndex("L4")));
                grp.setL5(c.getString(c.getColumnIndex("L5")));
                groups.add(grp);
